...
const Points = () => {
    ...
    const [itemSelected, setItemSelected] = useState<number[]>([0, 0]);
    ...
    useEffect(() => {
        async function getInitialPosition() {
            ...
            if(status !== 'granted') {
                return Alert.alert('Error', 'Precisamos da permissao para te localizar.');
            }
                ...
                >
                    {
                        items.map(item => (
                            <TouchableOpacity 
                                ...
                                style={[
                                    styles.item,
                                    itemSelected.includes(item.id) ? styles.selectedItem : {}
                                ]}
